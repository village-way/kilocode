...
Le skill degli agenti permettono a Kilo di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
Kilo cerca in queste posizioni:
...
Per i percorsi locali al progetto, Kilo risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
Kilo elenca le skill disponibili nella descrizione dello strumento `skill`.
