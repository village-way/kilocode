---
title: Zen
description: Lista curata di modelli fornita da Kilo.
---
...
OpenCode Zen e una lista di modelli testati e verificati dal team di Kilo.

:::note
OpenCode Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in Kilo. Accedi a OpenCode Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare Kilo.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Kilo.
:::
...
OpenCode Zen funziona come qualunque altro provider in Kilo.
...
Il [model id](/docs/config/#models) nella config di Kilo usa il formato `opencode/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `opencode/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su Kilo per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su Kilo per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su Kilo per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su Kilo per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Kilo.
