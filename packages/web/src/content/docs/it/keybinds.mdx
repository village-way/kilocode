...
Kilo ha una lista di scorciatoie che puoi personalizzare tramite la configurazione di Kilo.
...
Kilo usa un tasto `leader` per la maggior parte delle scorciatoie. Questo evita conflitti nel terminal.
