...
Con Kilo puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminal oppure definire un tema personalizzato.

Per impostazione predefinita, Kilo usa il tema `opencode`.
...
Kilo include diversi temi integrati.
...
- Vuole che Kilo corrisponda all'aspetto del terminal
...
Kilo supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
