---
title: Server LSP
description: Kilo si integra con i tuoi server LSP.
---

Kilo si integra con il tuo Language Server Protocol (LSP) per aiutare l'LLM a interagire con la tua codebase. Usa le diagnostiche per fornire feedback all'LLM.

---

## Integrati

Kilo include diversi server LSP integrati per linguaggi popolari:
