---
title: Ecosistema
description: Progetti e integrazioni costruiti con Kilo.
---

Una raccolta di progetti della comunita costruiti su Kilo.

:::note
Vuoi aggiungere il tuo progetto legato a Kilo a questa lista? Apri una PR.
:::
...
| Nome                                                                                                      | Descrizione                                                                                       |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/jamesmurdza/daytona/blob/main/guides/typescript/opencode/README.md) | Esegue automaticamente sessioni Kilo in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                       | Traccia l'uso di Kilo con Wakatime                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                                   | Notifiche desktop e avvisi sonori per le sessioni Kilo                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                                   | Naming automatico delle sessioni Zellij basato sul contesto Kilo                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                       | Permette agli agenti Kilo di caricare prompt al bisogno con discovery e injection di skill    |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                           | Notifiche native del sistema per Kilo: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                       | Git worktree senza attriti per Kilo                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni Kilo, costruito sull'SDK    |
...
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per Kilo su Tailscale/VPN                    |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin Kilo                               |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim per opencode: un agente di coding AI per terminal    |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare Kilo tramite @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per Kilo                   |
| [Kilo-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra Kilo nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da Kilo      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni Kilo con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per Kilo                |
