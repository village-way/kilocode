...
description: Novita in Kilo 1.0.
---

Kilo 1.0 e una riscrittura completa della TUI.
...
Detto questo, alcune versioni piu vecchie di Kilo installano sempre l'ultima.
