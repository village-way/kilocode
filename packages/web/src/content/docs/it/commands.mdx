...
Puoi aggiungere comandi personalizzati tramite la config di Kilo o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Kilo:
