---
title: IDE
description: Kilo-utvidelsen for VS Code, Cursor og andre IDE-er
---

Kilo integreres med VS Code, Cursor eller en hvilken som helst IDE som støtter en terminal. Bare kjør `opencode` i terminalen for å komme i gang.

---

## Bruk

- **Hurtigstart**: Bruk `Cmd+Esc` (Mac) eller `Ctrl+Esc` (Windows/Linux) for å åpne Kilo i en delt terminalvisning, eller fokuser en eksisterende terminaløkt hvis en allerede kjører.
- **Ny økt**: Bruk `Cmd+Shift+Esc` (Mac) eller `Ctrl+Shift+Esc` (Windows/Linux) for å starte en ny Kilo-terminaløkt, selv om en allerede er åpen. Du kan også klikke på Kilo-knappen i UI.
- **Kontekstbevissthet**: Del automatisk ditt nåværende valg eller fane med Kilo.
...
For å installere Kilo på VS Code og populære forgreninger som Cursor, Windsurf, VSCodium:
...
Søk etter **Kilo** i Extension Marketplace og klikk på **Install**.
