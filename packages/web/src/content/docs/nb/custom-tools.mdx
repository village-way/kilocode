...
description: Lag verktøy som LLM kan kalle inn Kilo.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan ringe under samtaler. De fungerer sammen med Kilo sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
