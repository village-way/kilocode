---
title: Økosystem
description: Prosjekter og integrasjoner bygget med Kilo.
---

En samling fellesskapsprosjekter bygget på Kilo.

:::note
Vil du legge til ditt Kilo-relaterte prosjekt til denne listen? Send inn en PR.
:::
...
| Navn                                                                                                      | Beskrivelse                                                                                                   |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/jamesmurdza/daytona/blob/main/guides/typescript/opencode/README.md) | Kjør Kilo-økter automatisk i isolerte Daytona-sandkasser med git-synkronisering og live forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                       | Spor Kilo-bruk med Wakatime                                                                               |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                                   | Skrivebordsvarsler og lydvarsler for Kilo-økter                                                           |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                                   | AI-drevet automatisk Zellij-sesjonsnavn basert på Kilo-kontekst                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                       | Tillat Kilo-agenter å lazy-loade meldinger på forespørsel med ferdighetsoppdagelse og injeksjon           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                                     | Utvid Kilo /kommandoer til et kraftig orkestreringssystem med granulær flytkontroll                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                           | Innfødte OS-varsler for Kilo – vet når oppgaver fullføres                                                 |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                       | Nullfriksjon git-arbeidstre for Kilo                                                                      |
...
| Navn                                                                                       | Beskrivelse                                                         |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot for å kontrollere Kilo-økter, bygget på SDK         |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge Kilo-plugins                                    |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-grensesnitt for Kilo - en terminalbasert AI-kodingsagent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av Kilo via @opencode-ai/sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/skrivebordsapp og VS Code-utvidelse for Kilo               |
| [Kilo-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-plugin som bygger inn Kilo i Obsidians UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av Kilo  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Kilo utvidelsesbehandler med bærbare, isolerte profiler.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile og Remote Client App for Kilo              |
