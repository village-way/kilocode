---
title: Web
description: Bruke Kilo i nettleseren din.
---

Kilo kan kjøres som en nettapplikasjon i nettleseren din, og gir den samme kraftige AI-kodingsopplevelsen uten at du trenger en terminal.

![Kilo Web - Ny økt](../../../assets/web/web-homepage-new-session.png)
...
Dette starter en lokal server på `127.0.0.1` med en tilfeldig tilgjengelig port og åpner automatisk Kilo i standard nettleser.
...
Som standard velger Kilo en tilgjengelig port. Du kan spesifisere en port:
...
Som standard binder serveren seg til `127.0.0.1` (kun lokal vert). Slik gjør du Kilo tilgjengelig på nettverket ditt:

```bash
opencode web --hostname 0.0.0.0
```

Når du bruker `0.0.0.0`, vil Kilo vise både lokale adresser og nettverksadresser:
...
Når det er startet, gir nettgrensesnittet tilgang til dine Kilo-økter.

### Sesjoner

Se og administrer øktene dine fra hjemmesiden. Du kan se aktive økter og starte nye.

![Kilo Web - Active Session](../../../assets/web/web-homepage-active-session.png)

### Serverstatus

Klikk "Se servere" for å se tilkoblede servere og deres status.

![Kilo Web - Se servere](../../../assets/web/web-homepage-see-servers.png)
