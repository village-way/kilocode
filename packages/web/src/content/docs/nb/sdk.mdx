---
title: SDK
description: Typesikker JS-klient for Kilo-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kilo JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Kilo programmatisk.
...
Hvis du allerede har en kjørende forekomst av Kilo, kan du opprette en klientforekomst for å koble til den:
