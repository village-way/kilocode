...
Det er to typer agenter i Kilo; primære agenter og subagenter.
...
Kilo kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Kilo kommer med to innebygde subagenter, **General** og **Explore**. Vi skal se på dette nedenfor.

---

## Innebygd

Kilo kommer med to innebygde primære agenter og to innebygde subagenter.
...
Hvis ingen temperatur er spesifisert, bruker Kilo modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Kilo-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Kilo-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [OpenCode Zen](/docs/zen), vil du bruke `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/Kilo-Org/kilo).
:::
