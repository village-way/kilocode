...
Kilo har en liste over nøkkelbindinger som du kan tilpasse gjennom Kilo-konfigurasjonen.
...
Kilo bruker en `leader`-nøkkel for de fleste nøkkelbindinger. Dette unngår konflikter i terminalen din.
