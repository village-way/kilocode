...
Du kan definere MCP-servere i [opencode Config](https://kilo.ai/docs/config/) under `mcp`. Legg til hver MCP med et unikt navn. Du kan referere til den MCP ved navn når du ber om LLM.
