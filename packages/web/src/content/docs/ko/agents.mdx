...
Kilo의 두 가지 유형이 있습니다; 기본 에이전트와 subagents.
...
Kilo는 두 개의 내장 기본 에이전트, **Build** 및 **Plan**와 함께 제공됩니다. 우리는
아래에서 보기.
...
Kilo는 두 개의 내장 subagents, **General** 및 **Explore**. 아래에서 볼 수 있습니다.

---

## 내장

Kilo는 기본 에이전트와 두 개의 내장 subagents로 제공됩니다.
...
:::tip
당신은 공유하고 싶은 에이전트이 있습니까? [PR](https://github.com/Kilo-Org/kilo).
:::
