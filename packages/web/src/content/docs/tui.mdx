---
title: TUI
description: Using the Kilo terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kilo provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Kilo starts the TUI for the current directory.
...
When using the Kilo TUI, you can type `/` followed by a command name to quickly execute actions. For example:
