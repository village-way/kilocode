---
title: Zen
description: Liste organisée de modèles fournis par Kilo.
---
...
OpenCode Zen est une liste de modèles testés et vérifiés fournie par l'équipe Kilo.

:::note
OpenCode Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans Kilo. Vous vous connectez à OpenCode Zen et obtenez
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Kilo.
:::
...
OpenCode Zen fonctionne comme n'importe quel autre fournisseur dans Kilo.
...
Le [id du modèle](/docs/config/#models) dans votre configuration Kilo
...
- GLM 4.7 Free est disponible sur Kilo pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Kimi K2.5 Free est disponible sur Kilo pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- MiniMax M2.1 Free est disponible sur Kilo pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur Kilo pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec Kilo également.
