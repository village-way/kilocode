...
Les compétences d'agent permettent à Kilo de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
Kilo recherche ces emplacements :
...
Pour les chemins locaux du projet, Kilo remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
Kilo répertorie les compétences disponibles dans la description de l'outil `skill`.
