...
Vous pouvez ajouter des commandes personnalisées via la configuration Kilo ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Kilo [config](/docs/config) :
