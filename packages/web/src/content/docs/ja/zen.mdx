---
title: 禅
description: Kilo によって提供されるモデルの厳選されたリスト。
---
...
OpenCode Zen は、Kilo チームによって提供される、テストおよび検証されたモデルのリストです。

:::note
OpenCode Zen は現在ベータ版です。
:::
Zen は Kilo の他のプロバイダーと同様に機能します。 OpenCode Zen にログインすると、
...
:::tip
私たちは、Kilo で適切に動作するモデルとプロバイダーの選択されたグループをテストしました。
:::
...
OpenCode Zen は、Kilo の他のプロバイダーと同様に機能します。
...
Kilo 設定の [model id](/docs/config/#models)
...
- GLM 4.7 Free は期間限定で Kilo で入手できます。チームはこの時間を利用してフィードバックを収集し、モデルを改善します。
- Kim K2.5 Free は Kilo で期間限定で利用可能です。チームはこの時間を利用してフィードバックを収集し、モデルを改善します。
- MiniMax M2.1 Free は期間限定で Kilo で入手できます。チームはこの時間を利用してフィードバックを収集し、モデルを改善します。
- Big Pickle は、期間限定で Kilo で無料で利用できるステルス モデルです。チームはこの時間を利用してフィードバックを収集し、モデルを改善します。
...
4. 他のコーディング エージェントとの併用を許可することで、**ロックイン**がなくなります。また、常に Kilo で他のプロバイダーも使用できるようにします。
