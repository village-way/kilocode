...
İkili dosyayı [Releases](https://github.com/Kilo-Org/kilo/releases)'dan da alabilirsiniz.
...
1. TUI'de `/connect` komutunu çalıştırın, opencode'u seçin ve [kilo.ai/auth](https://kilo.ai/auth)'ye gidin.
...
İşte opencode'lu bir [örnek konuşma](https://kilo.ai/s/4XP1fce5).
