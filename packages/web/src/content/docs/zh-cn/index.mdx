...
您还可以从 [Releases](https://github.com/Kilo-Org/kilo/releases) 获取二进制文件。
...
1. 在 TUI 中运行 `/connect` 命令，选择 opencode，然后前往 [kilo.ai/auth](https://kilo.ai/auth)。
...
这是带有 opencode 的 [示例对话](https://kilo.ai/s/4XP1fce5)。
