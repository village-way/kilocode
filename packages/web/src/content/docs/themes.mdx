...
With Kilo you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Kilo uses our own `opencode` theme.
...
Kilo comes with several built-in themes.
...
- Want Kilo to match their terminal's appearance
...
Kilo supports a flexible JSON-based theme system that allows users to create and customize themes easily.
