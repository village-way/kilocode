...
Вы также можете получить двоичный файл из файла [Releases](https://github.com/Kilo-Org/kilo/releases).
...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [kilo.ai/auth](https://kilo.ai/auth).
...
Вот [пример диалога](https://kilo.ai/s/4XP1fce5) с opencode.
