...
- Apenas macOS: menu `Kilo` -> **Recarregar Webview** (ajuda se a interface estiver em branco/congelada).
...
3. Certifique-se de que você tem a versão mais recente com `kilo upgrade`
