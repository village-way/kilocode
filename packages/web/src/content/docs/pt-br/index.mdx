...
Você também pode baixar o binário na seção [Releases](https://github.com/Kilo-Org/kilo/releases).
...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [kilo.ai/auth](https://kilo.ai/auth).
...
Aqui está uma [conversa de exemplo](https://kilo.ai/s/4XP1fce5) com o opencode.
