---
title: LSP Servers
description: Kilo integrates with your LSP servers.
---

Kilo integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

Kilo comes with several built-in LSP servers for popular languages:
