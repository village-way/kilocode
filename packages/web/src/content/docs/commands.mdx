...
You can add custom commands through the Kilo config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Kilo [config](/docs/config):
