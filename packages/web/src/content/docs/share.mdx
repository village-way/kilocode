---
title: Share
description: Share your Kilo conversations.
---

Kilo's share feature allows you to create public links to your Kilo conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Kilo:
...
Kilo supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Kilo uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
