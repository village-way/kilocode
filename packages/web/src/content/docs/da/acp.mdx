---
title: ACP support
description: Brug Kilo i enhver ACP-kompatibel editor.
---
...
For at bruge Kilo via ACP, konfigurer din editor til at køre kommandoen `opencode acp`.
...
For at åbne den skal du bruge den nye 'Kilo'-agent i AI Chat-agentvælgeren.
...
For at bruge Kilo som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge Kilo som ACP-agent til chat.
