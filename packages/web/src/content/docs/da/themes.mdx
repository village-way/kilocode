...
Med Kilo kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger Kilo vårt eget `opencode`-tema.
...
Kilo kommer med flere innebygde temaer.
...
- Vil at Kilo skal matche terminalens utseende
...
Kilo støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
