...
I begge tilfælde vil Kilo køre på dine GitLab-løbere.

---

## GitLab CI

Kilo fungerer i en almindelig GitLab-pipeline. Du kan bygge det ind i en pipeline som en [CI component](https://docs.gitlab.com/ee/ci/components/)

Her bruger vi en community-skabt CI/CD-komponent til Kilo — [nagyv/gitlab-opencode](https://gitlab.com/nagyv/gitlab-opencode).

---

### Funktioner

- **Brug brugerdefineret konfiguration pr. job**: Konfigurer Kilo med en brugerdefineret konfigurationsmappe, for eksempel `./config/#custom-directory` for at aktivere eller deaktivere funktionalitet pr. Kilo påkald.
- **Minimal opsætning**: CI-komponenten sætter Kilo op i baggrunden, du behøver kun at oprette Kilo-konfigurationen og den indledende prompt.
...
Kilo integreres med din GitLab-arbejdsgang.
Nævn `@opencode` i en kommentar, og Kilo vil udføre opgaver i din GitLab CI-pipeline.
...
Kilo kører i din GitLab CI/CD pipeline, her er hvad du skal bruge for at konfigurere det:
...
Her er nogle eksempler på, hvordan du kan bruge Kilo i GitLab.
...
- **Forklar et problem**
  ...
  Kilo vil læse spørgsmålet og svare med en klar forklaring.
