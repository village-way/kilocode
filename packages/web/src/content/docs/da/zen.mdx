---
title: Zen
description: Utvalgt liste over modeller levert av Kilo.
---
...
OpenCode Zen er en liste over testede og verifiserte modeller levert av Kilo-teamet.

:::note
OpenCode Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i Kilo. Du logger på OpenCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Kilo.
:::
...
OpenCode Zen fungerer som alle andre leverandører i Kilo.
...
[modell-id](/docs/config/#models) i Kilo-konfigurasjonen
...
- GLM 4.7 Free er tilgængelig på Kilo i en begrænset periode. Teamet bruger denne tiden til at samle tilbagemeldinger og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på Kilo i en begrænset periode. Teamet bruger denne tiden til at samle tilbagemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgængelig på Kilo i en begrænset periode. Teamet bruger denne tiden til at samle tilbagemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Kilo i en begrænset periode. Teamet bruger denne tiden til at samle tilbagemeldinger og forbedre modellen.
...
4. Ha **ingen låsing** ved at la deg bruge den med en hvilken som helst annen kodeagent. Og la deg alltid bruge en hvilken som helst annen leverandør med Kilo også.
