...
- `model`: Den model, der skal bruges med Kilo. Antager formatet `provider/model`. Dette er **påkrævet**.
...
Kilo kan udløses af følgende GitHub hændelser:
...
Kør Kilo efter en tidsplan for at udføre automatiske opgaver:
...
Her er nogle eksempler på, hvordan du kan bruge Kilo i GitHub.
...
- **Forklar et problem**
  ...
  Kilo vil læse hele tråden, inklusive alle kommentarer, og svare med en klar forklaring.
...
- **Gennemgå PR'er og foretag ændringer**
  ...
  Kilo vil implementere den ønskede ændring og forpligtelse til den samme PR.

- **Gennemgå specifikke kodelinjer**

  Efterlad en kommentar direkte på kodelinjer i PR's faneblad "Filer". Kilo detekterer automatisk filer, linjenumrene og diff-konteksten for at give præcise svar.
  ...
  Når du kommenterer på specifikke linjer, modtager Kilo:
