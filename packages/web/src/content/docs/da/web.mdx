---
title: Web
description: Brug af Kilo i din browser.
---

Kilo kan køre som en webapplikation i din browser, hvilket giver den samme kraftfulde AI-kodningsoplevelse uden behov for en terminal.

![Kilo Web - Ny session](../../../assets/web/web-homepage-new-session.png)
...
Dette starter en lokal server på `127.0.0.1` med en tilfældig tilgængelig port og åbner automatisk Kilo i din standardbrowser.
...
Som standard vælger Kilo en tilgængelig port. Du kan angive en port:
...
Som standard binder serveren til `127.0.0.1` (kun lokal vært). Sådan gør du Kilo tilgængelig på dit netværk:

```bash
opencode web --hostname 0.0.0.0
```

Når du bruger `0.0.0.0`, vil Kilo vise både lokale adresser og netværksadresser:
...
Når den er startet, giver webgrænsefladen adgang til dine Kilo-sessioner.
