---
title: Dele
description: Del dine Kilo-samtaler.
---

OpenCodes delingsfunksjon lar deg lage offentlige lenker til dine Kilo-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Kilo støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruger Kilo manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
