---
title: TUI
description: Bruge Kilo-terminalbrugergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kilo gir et interaktivt terminalgrensesnitt eller TUI for at jobbe med prosjektene dine med en LLM.

Å kjøre Kilo starter TUI for nuværende katalog.
...
Når du bruger Kilo TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt at utføre handlinger. For eksempel:
...
Legg til en leverandør til Kilo. Lar deg velge fra tilgængelige leverandører og tilføje til deres API-nøkler.
...
Du kan tilpasse TUI-oppførselen gjennom Kilo-konfigurasjonsfilen.
