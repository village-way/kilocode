...
Kilo leveres med indbyggede primære agenter, **Build** og **Plan**. Godt
...
Kilo leveres med til indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbygget

Kilo leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Hvis ingen temperatur er angivet, bruger Kilo modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Kilo-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Kilo-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [OpenCode Zen](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Har du en agent, du gerne vil dele? [Submit a PR](https://github.com/Kilo-Org/kilo).
:::
