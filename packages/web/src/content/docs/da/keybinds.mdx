...
Kilo har en liste over nøglebindinger, som du kan tilpasse gennem Kilo-konfigurationen.
...
Kilo bruger en `leader` nøgle til de fleste smagsbindinger. Dette undgår konflikter i din terminal.
