...
Agentferdigheter lar Kilo oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Kilo søker etter disse stedene:
...
For prosjektlokale stier går Kilo opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Kilo viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
