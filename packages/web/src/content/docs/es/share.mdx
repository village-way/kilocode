---
title: Compartir
description: Comparte tus conversaciones Kilo.
---

La función para compartir de Kilo te permite crear enlaces públicos a tus conversaciones de Kilo, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Kilo:
...
Kilo admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Kilo usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
