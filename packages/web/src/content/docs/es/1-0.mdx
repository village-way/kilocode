...
description: Novedades de Kilo 1.0.
---

Kilo 1.0 es una reescritura completa de TUI.
...
versión. Sin embargo, algunas versiones anteriores de Kilo siempre obtienen la última versión.
