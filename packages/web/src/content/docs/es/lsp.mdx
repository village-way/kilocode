...
description: Kilo se integra con sus servidores LSP.
---

Kilo se integra con su protocolo de servidor de idiomas (LSP) para ayudar a LLM a interactuar con su código base. Utiliza diagnósticos para proporcionar retroalimentación al LLM.

---

## Incorporado

Kilo viene con varios servidores LSP integrados para idiomas populares:
