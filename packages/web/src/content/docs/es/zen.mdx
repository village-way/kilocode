---
title: zen
description: Lista seleccionada de modelos proporcionada por Kilo.
---
...
OpenCode Zen es una lista de modelos probados y verificados proporcionada por el equipo Kilo.

:::note
OpenCode Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en Kilo. Inicias sesion en OpenCode Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar Kilo.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Kilo.
:::
...
OpenCode Zen funciona como cualquier otro proveedor en Kilo.
...
El [model ID](/docs/config/#models) en tu configuracion de Kilo
...
- GLM 4.7 Free está disponible en Kilo por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Kimi K2.5 Free está disponible en Kilo por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.1 Free está disponible en Kilo por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en Kilo por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con Kilo también.
