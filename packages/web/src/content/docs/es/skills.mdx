...
Las habilidades del agente permiten a Kilo descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Para las rutas locales del proyecto, Kilo sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
Kilo enumera las habilidades disponibles en la descripción de la herramienta `skill`.
