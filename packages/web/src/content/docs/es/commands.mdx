...
Puede agregar comandos personalizados a través de la configuración Kilo o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Kilo [config](/docs/config):
