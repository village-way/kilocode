...
Kilo tiene una lista de combinaciones de teclas que puede personalizar a través de la configuración Kilo.
...
Kilo usa una tecla `leader` para la mayoría de las combinaciones de teclas. Esto evita conflictos en tu terminal.
