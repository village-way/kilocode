---
title: TUI
description: Arbeite mit Kilo in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kilo bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Kilo die TUI im aktuellen Verzeichnis.
...
In der Kilo-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to Kilo. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Kilo config file.
