...
Wenn Kilo Probleme macht, starte mit Logs und lokal gespeicherten Daten auf der Festplatte.
...
Kilo Desktop startet im Hintergrund einen lokalen Kilo-Server (`opencode-cli`-Sidecar).
...
- Nur macOS: `Kilo`-Menue -> **Reload Webview** (hilft bei leerer/eingefrorener UI)
...
Wenn du Probleme mit Kilo hast:
