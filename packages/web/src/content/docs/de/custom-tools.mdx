...
description: Erstellen Sie Tools, die der LLM in Kilo aufrufen kann.
---

Benutzerdefinierte Tools sind von Ihnen erstellte Funktionen, die der LLM während Gesprächen aufrufen kann. Sie arbeiten neben [built-in tools](/docs/tools) von Kilo wie `read`, `write` und `bash`.
