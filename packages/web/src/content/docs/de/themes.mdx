...
Mit Kilo kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Kilo das `opencode`-Theme.
...
Kilo liefert mehrere eingebaute Themes mit.
...
- Kilo optisch ans Terminal anpassen wollen
...
Kilo unterstuetzt ein flexibles JSON-basiertes Theme-System.
