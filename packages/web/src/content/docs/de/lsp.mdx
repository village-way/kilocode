---
title: LSP Server
description: Kilo lässt sich in Ihren LSP-Server integrieren.
---

Kilo lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Eingebaut

Kilo verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn Kilo eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Kilo-Konfiguration anpassen.
