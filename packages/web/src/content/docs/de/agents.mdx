...
Es gibt zwei Arten von Agenten in Kilo; Primäragenten und Subagenten.
...
Kilo verfügt über zwei integrierte Primäragenten: **Build** und **Plan**. Auch
...
Kilo verfügt über zwei integrierte Subagenten: **General** und **Explore**. Wir werden uns das weiter unten ansehen.

---

## Eingebaut

Kilo verfügt über zwei integrierte Primäragenten und zwei integrierte Subagenten.
...
Wenn keine Temperatur angegeben ist, verwendet Kilo modellspezifische Standardwerte; typischerweise 0 für die meisten Modelle, 0.55 für Qwen-Modelle.
...
Dieser Pfad ist relativ zum Speicherort der Konfigurationsdatei. Dies funktioniert sowohl für die globale Kilo-Konfiguration als auch für die projektspezifische Konfiguration.
...
Das Modell ID in Ihrer Kilo-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [OpenCode Zen](/docs/zen) verwenden, würden Sie `opencode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
...
:::tip
Haben Sie einen Agenten, den Sie gerne teilen möchten? [Submit a PR](https://github.com/Kilo-Org/kilo).
:::
