---
title: Zen
description: Kuratierte Modellliste direkt von Kilo.
---
...
OpenCode Zen ist eine vom Kilo-Team getestete und verifizierte Modellliste.

:::note
OpenCode Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Kilo.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit Kilo funktionieren.
:::
...
OpenCode Zen funktioniert wie jeder andere Provider in Kilo.
...
Die [Model-ID](/docs/config/#models) in deiner Kilo-Konfiguration hat das Format `opencode/<model-id>`.
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und Kilo weiter mit anderen Providern nutzen kannst
