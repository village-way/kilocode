...
Agent Skills erlauben Kilo, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
Kilo sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft Kilo vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
Kilo listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
