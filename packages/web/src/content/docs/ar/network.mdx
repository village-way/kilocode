...
يدعم Kilo متغيرات بيئة الوكيل (proxy) القياسية والشهادات المخصصة لبيئات الشبكات المؤسسية.

---

## الوكيل

يتبع Kilo متغيرات بيئة الوكيل القياسية.
...
إذا كانت مؤسستك تستخدم سلطات تصديق (CA) مخصصة لاتصالات HTTPS، فقم بإعداد Kilo ليثق بها.
