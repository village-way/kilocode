---
title: خوادم LSP
description: يتكامل Kilo مع خوادم LSP لديك.
---

يتكامل Kilo مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Kilo مع عدة خوادم LSP مدمجة للغات الشائعة:
