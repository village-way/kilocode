---
title: النظام البيئي
description: مشاريع وتكاملات مبنية باستخدام Kilo.
---

مجموعة من مشاريع المجتمع المبنية على Kilo.

:::note
هل تريد إضافة مشروع مرتبط بـ Kilo إلى هذه القائمة؟ قدّم PR.
:::
...
| الاسم                                                                                                     | الوصف                                                                                     |
| --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/jamesmurdza/daytona/blob/main/guides/typescript/opencode/README.md) | تشغيل جلسات Kilo تلقائيا داخل بيئات Daytona معزولة مع مزامنة git ومعاينات حية         |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                       | تتبع استخدام Kilo عبر Wakatime                                                        |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                                   | إشعارات سطح المكتب وتنبيهات صوتية لجلسات Kilo                                         |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                                   | تسمية جلسات Zellij تلقائيا بالاعتماد على سياق Kilo وبمساعدة الذكاء الاصطناعي          |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                       | تمكين وكلاء Kilo من تحميل الموجهات عند الطلب عبر اكتشاف المهارات وحقنها               |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                           | إشعارات نظام تشغيل أصلية لـ Kilo - اعرف متى تكتمل المهام                              |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                                     | حزمة تنسيق متعددة الوكلاء - 16 مكوّنا، تثبيت واحد                                         |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                       | git worktrees بلا تعقيد لـ Kilo                                                       |
...
| الاسم                                                                                      | الوصف                                                                    |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| [kimaki](https://github.com/remorses/kimaki)                                               | بوت Discord للتحكم بجلسات Kilo، مبني على SDK                         |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | ملحق Neovim لموجهات تراعي المحرر، مبني على API                           |
| [portal](https://github.com/hosenur/portal)                                                | واجهة ويب تركز على الجوال لـ Kilo عبر Tailscale/VPN                  |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | قالب لبناء ملحقات Kilo                                               |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | موفر Vercel AI SDK لاستخدام Kilo عبر @opencode-ai/sdk                |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | تطبيق ويب/سطح مكتب وامتداد VS Code لـ Kilo                           |
| [Kilo-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | ملحق Obsidian يدمج Kilo داخل واجهة Obsidian                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | بديل مفتوح المصدر لـ Claude Cowork، مدعوم بـ Kilo                    |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | مدير امتدادات Kilo مع ملفات تعريف محمولة ومعزولة.                    |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | تطبيق عميل لسطح المكتب والويب والجوال وعن بُعد لـ Kilo               |
