---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها Kilo.
---
...
OpenCode Zen هي قائمة بالنماذج التي اختبرها فريق Kilo وتحقّق منها.

:::note
OpenCode Zen متاح حاليا بنسخة تجريبية.
:::

يعمل Zen مثل أي مزوّد آخر في Kilo. تسجّل الدخول إلى OpenCode Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام Kilo.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع Kilo.
:::
...
يعمل OpenCode Zen مثل أي مزوّد آخر في Kilo.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات Kilo الصيغة `opencode/<model-id>`.
...
- GLM 4.7 Free متاح على Kilo لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Kimi K2.5 Free متاح على Kilo لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- MiniMax M2.1 Free متاح على Kilo لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على Kilo لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. عدم فرض **أي ارتباط حصري (lock-in)** عبر تمكينك من استخدامه مع أي عامل برمجة آخر، مع إتاحة استخدام أي مزوّد آخر مع Kilo أيضا.
