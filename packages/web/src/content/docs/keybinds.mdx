...
Kilo has a list of keybinds that you can customize through the Kilo config.
...
Kilo uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
