---
title: TUI
description: 使用 Kilo terminal 用戶介面。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kilo 提供了一個交互式 terminal 介面或 TUI，供您與 LLM 一起處理項目。

運行 Kilo 會啟動當前目錄的 TUI。
...
使用 Kilo TUI 時，您可以鍵入 `/` 後跟命令名稱來快速執行操作。例如：
...
將提供商添加到 Kilo。允許您從可用的提供商中進行選擇並添加其 API 密鑰。
