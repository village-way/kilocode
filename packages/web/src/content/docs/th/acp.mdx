---
title: ACPสามารถช่วย
description: ใช้ Kilo ในโปรแกรมแก้ไขที่ต้องการ ACP
---
...
บางครั้งใช้ Kilo ผ่าน ACP ไม่อนุญาตให้โปรแกรมแก้ไขของคุณให้รันคำสั่ง `opencode acp`

สั่งเริ่ม Kilo เนื่องจากต้องย่อยที่จำเป็นต้องมี ACP ซึ่งจะต้องแก้ไขโปรแกรมของคุณผ่าน JSON-RPC ผ่าน stdio
