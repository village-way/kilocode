---
title: การรองรับ ACP
description: ใช้ Kilo ในโปรแกรมแก้ไขที่รองรับ ACP
---

Kilo ที่แสดง [Agent Client Protocol](https://agentclientprotocol.com) หรือ (ACP) ซึ่งสามารถช่วยได้โดยตรงในการแก้ไขและ IDE ที่หน่วยความจำ
...
ในการใช้ Kilo ผ่าน ACP ให้กำหนดค่าโปรแกรมแก้ไขของคุณให้รันคำสั่ง `opencode acp`

คำสั่งนี้จะเริ่ม Kilo เป็นกระบวนการย่อยที่เข้ากันได้กับ ACP ซึ่งสื่อสารกับโปรแกรมแก้ไขของคุณผ่าน JSON-RPC ผ่าน stdio
...
นี่เป็นการเปิดให้ตัวแทน 'Kilo' ในเนื้อหาของตัวแทน AI Chat
...
ลองใช้ Kilo ACP ใน [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ให้เพิ่มสิ่งต่อไปนี้ใน Neovim ของคุณ:
...
- MCP แขกที่นี่คือข้อมูลเพิ่มเติมของ Kilo ของคุณ
