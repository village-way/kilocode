...
Kilo มีเอเจนต์สองประเภทตัวแทนหลักและตัวแทนย่อย
...
Kilo ของเอเจนต์หลักในตัวได้แก่ **Build** และ **Plan** ดี
ดูด้านล่าง
...
Kilo ในการควบคุมเอเจนต์ย่อยในส่วนนี้ได้แก่ **ทั่วไป** และ **สำรวจ** ส่วนดูพื้นที่

---

## บิวท์อิน

Kilo สืบสวนเอเจนต์หลักในตัวและเอเจนต์ย่อยในอีกหนึ่ง
...
ข้อสังเกตอุณหภูมิ Kilo โดยทั่วไปจะมีเฉพาะรุ่นเท่านั้นแล้ว 0 สำหรับรุ่นส่วนใหญ่ 0.55 สำหรับรุ่น Qwen
...
เกี่ยวเนื่องกับสิ่งนี้กับระบบไฟล์ที่อาจเป็นสาเหตุว่าทำไมจึงสามารถใช้ได้กับทั้ง Kilo ส่วนกลางและเฉพาะโครงการ
...
รหัสโมเดลในบางครั้ง Kilo ของคุณใช้รูปแบบ `provider/model-id` เช่นต้องใช้ [OpenCode Zen](/docs/zen) แล้วก็ใช้ `opencode/gpt-5.1-codex` สำหรับ GPT 5.1 Codex
...
:::tip
คุณเป็นตัวแทนคุณต้องการแบ่งปันหรือไม่? [ส่งประชาสัมพันธ์](https://github.com/Kilo-Org/kilo)
:::
