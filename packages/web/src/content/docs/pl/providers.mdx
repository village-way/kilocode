...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [kilo.ai/auth](https://kilo.ai/auth).
...
1. **Sprawdź konfigurację uwierzytelniania**: Uruchom `kilo auth list`, aby sprawdzić, czy poświadczenia
