...
- Tylko macOS: menu `Kilo` -> **Załaduj ponownie przeglądarkę internetową** (pomaga, jeśli interfejs użytkownika jest pusty/zawieszony).
...
3. Upewnij się, że masz najnowszą wersję z `kilo upgrade`
