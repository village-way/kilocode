...
Możesz także otrzymać plik binarny z [Releases](https://github.com/Kilo-Org/kilo/releases).
...
1. Uruchom opcję `/connect` w TUI, wybierz opencode i przejdź do [kilo.ai/auth](https://kilo.ai/auth).
...
Oto [przykładowa rozmowa](https://kilo.ai/s/4XP1fce5) z opencode.
