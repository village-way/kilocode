...
Možete dodati prilagođene komande kroz Kilo konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Kilo [config](/docs/config):
