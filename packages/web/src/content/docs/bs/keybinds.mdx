...
Kilo ima listu veza ključeva koje možete prilagoditi preko Kilo konfiguracije.
...
Kilo koristi `leader` ključ za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
