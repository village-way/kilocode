---
title: LSP serveri
description: Kilo se integriše sa vašim LSP serverima.
---

Kilo se integriše sa vašim Language Server Protocol (LSP) serverima kako bi pomogao LLM-u u interakciji s kodnom bazom. Koristi dijagnostiku za slanje povratnih informacija modelu.

## Ugrađeno

Kilo dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
