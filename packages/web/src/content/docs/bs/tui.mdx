---
title: TUI
description: Korištenje korisničkog interfejsa Kilo terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Kilo pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Kilo pokreće TUI za trenutni direktorij.
...
Kada koristite Kilo TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Kilo. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Kilo. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg Kilo konfiguracionog fajla.
