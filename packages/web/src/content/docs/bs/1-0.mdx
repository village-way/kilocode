...
description: Šta je novo u Kilo 1.0.
---

Kilo 1.0 je potpuna revizija TUI-ja.
...
Novi TUI radi kao stari jer se povezuje na isti kilo server.
...
verzija. Međutim, neke starije verzije Kilo uvijek uzimaju najnoviju verziju.
