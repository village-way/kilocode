...
U Kilo mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Kilo koristi nasu `opencode` temu.
...
Kilo dolazi sa vise ugradenih tema.
...
- Zele da Kilo odgovara izgledu njihovog terminala
...
Kilo podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
