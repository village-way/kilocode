---
title: Zen
description: Kurirana lista modela koje nudi Kilo.
---
...
OpenCode Zen je lista testiranih i provjerenih modela koje obezbjeduje Kilo tim.

:::note
OpenCode Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u Kilo. Prijavite se u OpenCode Zen i uzmete API kljuc. Ovo je **potpuno opcionalno** i ne morate ga koristiti da biste koristili Kilo.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Kilo.
:::
...
OpenCode Zen radi kao i svaki drugi provajder u Kilo.
...
[model id](/docs/config/#models) u Kilo konfiguraciji koristi format `opencode/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `opencode/gpt-5.2-codex`.
...
- GLM 4.7 Free je dostupan na Kilo ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- Kimi K2.5 Free je dostupan na Kilo ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- MiniMax M2.1 Free je dostupan na Kilo ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- Big Pickle je stealth model koji je besplatan na Kilo ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
...
4. Obezbijedimo **bez lock-ina** tako da Zen mozete koristiti sa bilo kojim coding agentom, uz slobodu koristenja drugih provajdera u Kilo.
