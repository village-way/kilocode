...
Agent skills omogucavaju Kilo da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Za projektne lokalne putanje, Kilo ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
Kilo navodi dostupne skills u opisu `skill` alata.
