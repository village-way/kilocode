---
title: Dijeljenje
description: Dijelite Kilo razgovore javnim linkovima.
---

Kilo opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kilo podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Manual (default)

Po defaultu, Kilo koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
