export const dict = {
  ...
  "desktop.error.serverStartFailed.title": "Kilo failed to start",
  "desktop.error.serverStartFailed.description":
    "The local Kilo server could not be started. Restart the app, or check your network settings (VPN/proxy) and try again.",
}
