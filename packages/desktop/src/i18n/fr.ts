export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Kilo",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Kilo a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.error.serverStartFailed.title": "Échec du démarrage d'Kilo",
  "desktop.error.serverStartFailed.description":
    "Impossible de démarrer le serveur Kilo local. Redémarrez l'application ou vérifiez vos paramètres réseau (VPN/proxy) et réessayez.",
}
