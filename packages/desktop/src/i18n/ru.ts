export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Kilo",
  ...
  "desktop.updater.downloaded.prompt": "Версия Kilo {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.error.serverStartFailed.title": "Не удалось запустить Kilo",
  "desktop.error.serverStartFailed.description":
    "Не удалось запустить локальный сервер Kilo. Перезапустите приложение или проверьте настройки сети (VPN/proxy) и попробуйте снова.",
}
