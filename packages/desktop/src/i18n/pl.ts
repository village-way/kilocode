export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Kilo",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Kilo. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.error.serverStartFailed.title": "Nie udało się uruchomić Kilo",
  "desktop.error.serverStartFailed.description":
    "Nie udało się uruchomić lokalnego serwera Kilo. Uruchom ponownie aplikację lub sprawdź ustawienia sieciowe (VPN/proxy) i spróbuj ponownie.",
}
