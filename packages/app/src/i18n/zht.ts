...
export const dict = {
  ...
  "provider.connect.kiloGateway.line1": "Kilo Gateway 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.kiloGateway.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.kiloGateway.visit.prefix": "造訪 ",
