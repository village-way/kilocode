...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>Kilo CLI | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="Kilo CLI terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Kilo CLI. Please read on to learn the rules and restrictions that govern your use of Kilo CLI
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Kilo CLI," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-opencode">What is Kilo CLI?</h2>
              <p>
                Kilo CLI is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Kilo CLI Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Kilo CLI enables you to
              ...
              <p>
                Kilo CLI takes the privacy of its users very seriously. For the current Kilo CLI Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using Kilo CLI?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Kilo CLI;
                </li>
                <li>
              ...
              <p>
                The Services enable you to access and use Third Party Models, which are not owned or controlled by Kilo
                CLI. Your ability to access Third Party Models is contingent on you having API keys or otherwise having
                the right to access such Third Party Models.
              </p>

              <p>
                Kilo CLI has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will Kilo CLI ever change the Services?</h2>
              <p>
              ...
              <p>
                Kilo CLI is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Kilo CLI has the sole right to decide whether you are
              ...
              <p>
                Kilo CLI and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Kilo CLI and all such
                parties together, the "Kilo CLI Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Kilo CLI Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Kilo CLI Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY KILO CLI (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                (INCLUDING, WITHOUT LIMITATION, TORT, CONTRACT, STRICT LIABILITY, OR OTHERWISE) SHALL ANY OF THE KILO
                CLI PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL, PUNITIVE
                ...
                (I) ONE-HUNDRED ($100) DOLLARS OR (II) THE AMOUNTS PAID AND/OR PAYABLE BY YOU TO KILO CLI IN CONNECTION
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Kilo CLI Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Kilo CLI's prior written
              ...
              <p>
                ...
                disputes and claims with Kilo CLI and limits the manner in which you can seek relief from Kilo CLI. Both
                you and Kilo CLI acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Kilo CLI's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Kilo CLI will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Kilo CLI will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Kilo CLI may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND KILO CLI WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Kilo CLI are instead choosing to have claims and disputes resolved by
                ...
                you and Kilo CLI over whether to vacate or enforce an arbitration award, YOU AND KILO CLI WAIVE ALL
              ...
              <p>
                ...
                this waiver of class or consolidated actions is deemed invalid or unenforceable, neither you nor Kilo
                CLI is entitled to arbitration; instead all claims and disputes will be resolved in a court as set forth
                in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Kilo CLI to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Kilo CLI agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Kilo CLI may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Kilo CLI agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Kilo CLI, and
                ...
                are not an employee, agent, partner, or joint venture of Kilo CLI, and you do not have any authority of
                any kind to bind Kilo CLI in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Kilo CLI
