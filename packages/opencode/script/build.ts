...
for (const item of targets) {
  ...
  await Bun.build({
    ...
    compile: {
      ...
      outfile: `dist/${name}/bin/zhanlu`, // zhanlu_change
      execArgv: [`--user-agent=zhanlu/${Script.version}`, "--use-system-ca", "--"], // zhanlu_change
      windows: {},
    },
  ...
  if (item.os === "linux") {
    ...
    if (interpreter) {
      try {
        await $`patchelf --set-interpreter ${interpreter} dist/${name}/bin/zhanlu`
