...
export class ContinueProxyApi extends OpenAIApi {
  ...
  override modifyCompletionBody<T extends CompletionCreateParamsNonStreaming | CompletionCreateParamsStreaming>(
    body: T,
  ): T {
    return this.modifyBodyWithContinueProperties(body)
  }

  override modifyFimBody<T extends FimCreateParamsStreaming>(body: T): T {
  ...
  override modifyRerankBody<T extends RerankCreateParams>(body: T): T {
    return {
      ...body,
      ...this.extraBodyProperties(),
    }
