...
const jsonSchemaTypeToGeminiType = (jsonSchemaType: string): GeminiObjectSchemaType => {
...
export function convertOpenAIToolToGeminiFunction(tool: ChatCompletionTool): GeminiToolFunctionDeclaration {
