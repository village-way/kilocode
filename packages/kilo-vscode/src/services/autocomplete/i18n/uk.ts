...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (вимкнено)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**На вашому рахунку немає кредитів**\n\nНа вашому рахунку 湛卢 немає кредитів. Щоб використовувати автодоповнення, будь ласка, поповніть рахунок.\n\n[Відкрити Налаштування](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Швидке Завдання",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори цю функцію для більшої ефективності'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Генерувати Запропоновані Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Запропоновані Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 блокується конфліктом з GitHub Copilot. Щоб виправити це, ти повинен вимкнути вбудовані пропозиції Copilot.",
