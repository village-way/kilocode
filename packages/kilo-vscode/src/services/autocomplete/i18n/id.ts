...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (dinonaktifkan)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Tidak ada kredit di akun kamu**\n\nAkun 湛卢 kamu tidak memiliki kredit. Untuk menggunakan autocomplete, silakan tambahkan kredit ke akun kamu.\n\n[Buka Pengaturan](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Tugas Cepat",
  "kilocode:autocomplete.input.placeholder": "mis., 'refaktor fungsi ini agar lebih efisien'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Hasilkan Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Suntingan yang Disarankan",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 diblokir oleh konflik dengan GitHub Copilot. Untuk memperbaiki ini, Anda harus menonaktifkan saran inline Copilot.",
