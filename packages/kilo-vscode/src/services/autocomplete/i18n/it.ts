...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (disabilitato)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Nessun credito nel tuo account**\n\nIl tuo account 湛卢 non ha crediti. Per usare l'autocompletamento, aggiungi crediti al tuo account.\n\n[Apri Impostazioni](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Attività Rapida",
  "kilocode:autocomplete.input.placeholder": "es., 'refactorizza questa funzione per renderla più efficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Genera Modifiche Suggerite",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Modifiche Suggerite",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Il 湛卢自动补全 è bloccato da un conflitto con GitHub Copilot. Per risolvere questo problema, devi disabilitare i suggerimenti in linea di Copilot.",
