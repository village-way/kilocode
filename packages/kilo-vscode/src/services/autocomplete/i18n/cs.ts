...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "湛卢: Rychlý úkol",
  "kilocode:autocomplete.input.placeholder": "např. 'refaktoruj tuto funkci, aby byla efektivnější'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Generovat navrhované úpravy",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 je blokováno konfliktem s GitHub Copilot. Pro vyřešení tohoto problému musíš zakázat inline návrhy Copilot.",
