...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (wyłączone)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Brak środków na koncie**\n\nTwoje konto 湛卢 nie ma środków. Aby korzystać z autouzupełniania, dodaj środki do swojego konta.\n\n[Otwórz Ustawienia](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Szybkie Zadanie",
  "kilocode:autocomplete.input.placeholder": "np. 'zrefaktoruj tę funkcję, aby była bardziej wydajna'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Generuj Sugerowane Edycje",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Sugerowane Edycje",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 jest blokowane przez konflikt z GitHub Copilot. Aby to naprawić, musisz wyłączyć sugestie inline Copilot.",
