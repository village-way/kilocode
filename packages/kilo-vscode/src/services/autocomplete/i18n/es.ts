...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "湛卢: Tarea Rápida",
  "kilocode:autocomplete.input.placeholder": "ej., 'refactoriza esta función para que sea más eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Generar Ediciones Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Ediciones Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El 湛卢自动补全 está siendo bloqueado por un conflicto con GitHub Copilot. Para solucionarlo, debes desactivar las sugerencias en línea de Copilot.",
