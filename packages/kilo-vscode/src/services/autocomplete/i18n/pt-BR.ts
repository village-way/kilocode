...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (desabilitado)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Sem créditos na sua conta**\n\nSua conta 湛卢 não tem créditos. Para usar o autocompletar, adicione créditos à sua conta.\n\n[Abrir Configurações](command:zhanlu.settingsButtonClicked)",
