...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全（無効）",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**アカウントにクレジットがありません**\n\n湛卢 アカウントにクレジットがありません。オートコンプリートを使用するには、アカウントにクレジットを追加してください。\n\n[設定を開く](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: クイックタスク",
  "kilocode:autocomplete.input.placeholder": "例：「この関数をより効率的にリファクタリングして」",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: 編集提案を生成",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: 編集提案",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全がGitHub Copilotとの競合によってブロックされています。これを修正するには、Copilotのインライン提案を無効にする必要があります。",
