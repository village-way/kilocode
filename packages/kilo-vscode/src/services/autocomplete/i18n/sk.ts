...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (zakázané)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Na tvojom účte nie sú žiadne kredity**\n\nTvoj účet 湛卢 nemá žiadne kredity. Pre použitie automatického doplňovania prosím pridaj kredity na svoj účet.\n\n[Otvoriť Nastavenia](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Rýchla úloha",
  "kilocode:autocomplete.input.placeholder": "napr. 'refaktoruj túto funkciu, aby bola efektívnejšia'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Generovať navrhované úpravy",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Navrhované úpravy",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 je blokované konfliktom s GitHub Copilot. Pre vyriešenie tohto problému musíš zakázať inline návrhy Copilot.",
