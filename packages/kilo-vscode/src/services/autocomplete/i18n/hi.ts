...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "湛卢: त्वरित कार्य",
  "kilocode:autocomplete.input.placeholder": "जैसे, 'इस फ़ंक्शन को अधिक कुशल बनाने के लिए रिफैक्टर करें'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: सुझाए गए संपादन जेनरेट करें",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: सुझाए गए संपादन",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 को GitHub Copilot के साथ संघर्ष के कारण ब्लॉक किया जा रहा है। इसे ठीक करने के लिए, आपको Copilot के इनलाइन सुझावों को अक्षम करना होगा।",
