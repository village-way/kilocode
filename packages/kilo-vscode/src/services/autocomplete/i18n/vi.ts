...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (đã tắt)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Không có tín dụng trong tài khoản của bạn**\n\nTài khoản 湛卢 của bạn không có tín dụng. Để sử dụng tự động hoàn thành, vui lòng thêm tín dụng vào tài khoản của bạn.\n\n[Mở Cài đặt](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Tác Vụ Nhanh",
  "kilocode:autocomplete.input.placeholder": "ví dụ, 'tái cấu trúc hàm này để hiệu quả hơn'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Tạo Các Chỉnh Sửa Được Đề Xuất",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Các Chỉnh Sửa Được Đề Xuất",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 đang bị chặn do xung đột với GitHub Copilot. Để khắc phục điều này, bạn phải tắt các gợi ý inline của Copilot.",
