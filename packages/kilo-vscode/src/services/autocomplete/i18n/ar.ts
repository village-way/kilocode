...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "湛卢: مهمة سريعة",
  "kilocode:autocomplete.input.placeholder": "مثال، 'أعد هيكلة هذه الدالة لتكون أكثر كفاءة'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: إنشاء التعديلات المقترحة",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: التعديلات المقترحة",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "يتم حظر 湛卢自动补全 بسبب تعارض مع GitHub Copilot. لإصلاح هذا، يجب عليك تعطيل اقتراحات Copilot المضمنة.",
