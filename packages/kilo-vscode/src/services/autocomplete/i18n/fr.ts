...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (désactivé)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Pas de crédits sur ton compte**\n\nTon compte 湛卢 n'a pas de crédits. Pour utiliser l'autocomplétion, ajoute des crédits à ton compte.\n\n[Ouvrir les Paramètres](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Tâche Rapide",
  "kilocode:autocomplete.input.placeholder": "ex., 'refactorise cette fonction pour plus d'efficacité'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Générer des Modifications Suggérées",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Modifications Suggérées",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Le 湛卢自动补全 est bloqué par un conflit avec GitHub Copilot. Pour résoudre cela, tu dois désactiver les suggestions en ligne de Copilot.",
