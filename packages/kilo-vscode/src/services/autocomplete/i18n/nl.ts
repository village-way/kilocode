...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (uitgeschakeld)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Geen tegoed op je account**\n\nJe 湛卢 account heeft geen tegoed. Om autocomplete te gebruiken, voeg tegoed toe aan je account.\n\n[Instellingen openen](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Snelle Taak",
  "kilocode:autocomplete.input.placeholder": "bijv., 'refactor deze functie om efficiënter te zijn'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Voorgestelde Bewerkingen Genereren",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Voorgestelde Bewerkingen",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "De 湛卢自动补全 wordt geblokkeerd door een conflict met GitHub Copilot. Om dit op te lossen, moet je Copilot's inline suggesties uitschakelen.",
