...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "湛卢: Hızlı Görev",
  "kilocode:autocomplete.input.placeholder": "örn., 'bu fonksiyonu daha verimli olacak şekilde yeniden düzenle'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Önerilen Düzenlemeler Oluştur",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Önerilen Düzenlemeler",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全, GitHub Copilot ile bir çakışma nedeniyle engelleniyor. Bunu düzeltmek için Copilot'un satır içi önerilerini devre dışı bırakmalısın.",
