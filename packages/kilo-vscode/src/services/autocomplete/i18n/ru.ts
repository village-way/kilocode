...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "湛卢: Быстрая Задача",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори эту функцию для большей эффективности'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Генерировать Предлагаемые Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Предлагаемые Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 блокируется конфликтом с GitHub Copilot. Чтобы исправить это, ты должен отключить встроенные предложения Copilot.",
