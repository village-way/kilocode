...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (deaktiviert)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**Kein Guthaben auf deinem Konto**\n\nDein 湛卢 Konto hat kein Guthaben. Um Autocomplete zu nutzen, füge bitte Guthaben zu deinem Konto hinzu.\n\n[Einstellungen öffnen](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Schnellaufgabe",
  "kilocode:autocomplete.input.placeholder": "z.B. 'refaktoriere diese Funktion für mehr Effizienz'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Bearbeitungsvorschläge generieren",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Bearbeitungsvorschläge",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Das 湛卢自动补全 wird durch einen Konflikt mit GitHub Copilot blockiert. Um dies zu beheben, musst du Copilots Inline-Vorschläge deaktivieren.",
