...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (ปิดใช้งาน)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**ไม่มีเครดิตในบัญชีของคุณ**\n\nบัญชี 湛卢 ของคุณไม่มีเครดิต หากต้องการใช้การเติมข้อความอัตโนมัติ กรุณาเพิ่มเครดิตในบัญชีของคุณ\n\n[เปิดการตั้งค่า](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: งานด่วน",
  "kilocode:autocomplete.input.placeholder": "เช่น 'ปรับโครงสร้างฟังก์ชันนี้ให้มีประสิทธิภาพมากขึ้น'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: สร้างการแก้ไขที่แนะนำ",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: การแก้ไขที่แนะนำ",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "湛卢自动补全 ถูกบล็อกโดยความขัดแย้งกับ GitHub Copilot เพื่อแก้ไขปัญหานี้ คุณต้องปิดใช้งานคำแนะนำแบบอินไลน์ของ Copilot",
