...
export const dict = {
  ...
  "kilocode:autocomplete.input.title": "湛卢: Tasca Ràpida",
  "kilocode:autocomplete.input.placeholder": "p. ex., 'refactoritza aquesta funció per ser més eficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Generar Edicions Suggerides",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Edicions Suggerides",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El 湛卢自动补全 està sent bloquejat per un conflicte amb GitHub Copilot. Per solucionar això, has de desactivar els suggeriments en línia de Copilot.",
