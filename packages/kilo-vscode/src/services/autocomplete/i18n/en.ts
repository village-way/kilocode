...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "湛卢自动补全 (disabled)",
  "kilocode:autocomplete.statusBar.tooltip.noCredits":
    "**No credits in your account**\n\nYour 湛卢 account has no credits. To use autocomplete, please add credits to your account.\n\n[Open Settings](command:zhanlu.settingsButtonClicked)",
  ...
  "kilocode:autocomplete.input.title": "湛卢: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "湛卢: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.codeAction.title": "湛卢: Suggested Edits",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The 湛卢自动补全 is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
