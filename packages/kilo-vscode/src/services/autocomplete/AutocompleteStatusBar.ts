...
const SUPPORTED_PROVIDER_DISPLAY_NAME = "Zhanlu Gateway"
const SETTINGS_COMMAND = `command:zhanlu.settingsButtonClicked?${encodeURIComponent(JSON.stringify(["autocomplete"]))}`
