...
| [Context Menus & Tooltips](chat-ui-features/context-menus-tooltips.md)         | 🔨 Partial     | Right-click context menus on chat messages, tool results, code blocks                      | Webview-only                                           | P2       |
| [File Permission Dialogs](chat-ui-features/file-permission-dialogs.md)         | 🔨 Partial     | Batch file read approval, per-file granularity, inline rendering instead of modal          | CLI permission model; webview UI                       | P1       |
| [Follow-Up Questions](chat-ui-features/follow-up-questions.md)                 | ❌ Not started | Suggested reply chips, click-to-submit, auto-approval countdown, mode indicators           | Likely extension-side generation                       | P2       |
...
| [Browser Automation & URL Ingestion](non-agent-features/browser-automation-url-ingestion.md)            | 🔨 Partial     | URL-to-markdown ingestion                                                                                                                  | CLI MCP hub (POST /mcp); extension manages lifecycle                 | P3       |
| [Checkpoints](non-agent-features/checkpoints.md)                                                        | 🔨 Partial     | Checkpoint service, shadow git repo, snapshot management, restore/diff UI                                                                  | CLI (partial: session undo/redo); extension for git snapshots        | P1       |
...
| [Search & Repo Scanning](non-agent-features/search-and-repo-scanning-infrastructure.md)                 | ❌ Not started | Search infrastructure beyond CLI grep/glob                                                                                                 | CLI has grep/glob; extension may add UI                              | P2       |
