...
export const dict = {
  ...
  "settings.aboutKiloCode.title": "關於 湛卢",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "湛卢 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutKiloCode.extensionName": "湛卢 擴充功能",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "將所有 湛卢 擴充功能設定重置為預設值。這不會影響 CLI 或後端設定。",
  ...
  "settings.language.description": "選擇 湛卢 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "從舊版 湛卢 安裝遷移設定，包括供應商 API 金鑰和預設模型。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "湛卢 新功能",
