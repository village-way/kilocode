export const dict = {
  ...
  "profile.action.login": "Entrar com 湛卢",
  ...
  "settings.aboutKiloCode.title": "Sobre o 湛卢",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "湛卢 é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensão 湛卢",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Redefinir todas as configurações da extensão 湛卢 para os valores padrão. Isso não afeta a configuração do CLI ou do backend.",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do 湛卢. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do 湛卢, incluindo chaves de API de provedor e modelo padrão.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no 湛卢",
